...
const bgPoster = require('../assets/images/bg_onboarding_4.png');
const bgOnboardingTransparent = require('../assets/images/bg_transparent_4.png');
    ...
    <ImageBackground
      ...
      <ImageBackground source={bgOnboardingTransparent} style={styles.bgPoster}>
        <View style={styles.container}>
          <Text style={styles.header}>Start Watching Now</Text>
          <TouchableOpacity
